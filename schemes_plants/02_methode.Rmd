...
Dit is een tweede versie van het monitoringsprotocol waarin enkele aanpassingen zijn gebeurd ten opzichte van de eerste versie [@van_landuyt_monitoringsprotocol_2019].
...
(*of toch ook resutaten van de INBO-meetnetten toevoegen??*) Voor de resultaten van de INBO-meetnetten verwijzen we naar ... (*output?*).
...
Sinds de start van de meetnetten in 2016 hebben `r monitoring_effort_overall[monitoring_effort_overall$monitoringsinspanning == "aantal tellers", "aantal"]` tellers `r monitoring_effort_overall[monitoring_effort_overall$monitoringsinspanning == "aantal tellingen", "aantal"]` tellingen op `r monitoring_effort_overall[monitoring_effort_overall$monitoringsinspanning == "aantal tellocaties", "aantal"]` meetnetlocaties ingevoerd.
In Figuur \@ref(fig:figinspanning) zien we de trend van de tellingen in de tijd voor alle vaatplantmeetnetten samen.

```{r figinspanning,  fig.cap = "Monitoringinspanning voor alle vaatplantmeetnetten samen", warning=TRUE}
